...
def generate_synthetic_point_sets() -> dict[str, np.ndarray]:
    ...
    clusters = np.vstack(
        [
            rng.normal(loc=(-2.0, -2.0, 0.5), scale=(0.18, 0.25, 0.12), size=(150, 3)),
            rng.normal(loc=(2.0, 1.5, -0.7), scale=(0.24, 0.18, 0.2), size=(150, 3)),
            rng.normal(loc=(0.0, 0.0, 2.0), scale=(0.15, 0.15, 0.15), size=(100, 3)),
        ]
    )
